    ...
    <div class="content-wrap">
        ...
        <main class="main-cont content mCustomScrollbar">
            <div class="page-wrap">
                ...
                <button class="btn btn-primary-outline"><a href="addnew_news.jsp">添加新文章</a></button>
                <form action="">
                    <table class="table table-bordered  mb-15">
                        ...
                        <c:forEach items="${news}" var="news">
                            <tr class="cen">
                                <td>${news.title_n}</td>
                                <td>${news.abstract_n}</td>
                                <td>${news.date_n}</td>
                                <td>${news.source_n}</td>
                                <td>
                                    <a href="/Servlet_select_news_id?title_n=${news.title_n}">修改</a>
                                    <a href="/Servlet_delete_news?title_n=${news.title_n}">删除</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </table>
