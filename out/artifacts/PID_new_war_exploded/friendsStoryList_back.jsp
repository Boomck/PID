    ...
    <div class="content-wrap">
        ...
        <main class="main-cont content mCustomScrollbar">
            <div class="page-wrap">
                ...
                <button class="btn btn-primary-outline"><a href="addnewfriendstory.jsp">添加新文章<a/></button>
                <form action="">
                    <table class="table table-bordered  mb-15">
                        ...
                        <c:forEach items="${friendsStoryList}" var="friend">
                            <tr class="cen">
                                <td>${friend.title_f}</td>
                                <td>${friend.date_f}</td>
                                <td>${friend.source_f}</td>
                                <td>
                                    <a href="/Servlet_select_friends_id?title_f=${friend.title_f}">修改</a>
                                    <a href="/Servlet_delete_friendstory?title_f=${friend.title_f}">删除</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </table>
