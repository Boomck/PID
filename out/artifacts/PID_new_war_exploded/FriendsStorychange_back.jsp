...
<%--%>--%>
<%
    FriendsStory friendsStory=(FriendsStory)session.getAttribute("friendsStory");
    User_c user_c;
    ...
    <div class="content-wrap">
        ...
        <main class="main-cont content mCustomScrollbar">
            <div class="page-wrap">
                ...
                <form action="/Servlet_changefriendstory" method="post" enctype="multipart/form-data">
                    <table id="tb1" border="1">
                        <tr height="30px">

                            <p><span>主题</span></p>
                            <div class="textWrap " style="position: relative;">
                                <input type="text" name="title_f" id="title_f" maxlength="10" style="padding-right: 70px;" value=<%=friendsStory.getTitle_f()%>>
                            ...
                            <p><span>内容</span></p>
                            <div class="textWrap" style="position: relative;">
                                <textarea name="text_f" id="text_f" cols="" rows="" maxlength="5000" rows="10" style="padding-bottom: 30px; height: 300px;"><%=friendsStory.getText_f()%></textarea>
                            ...
                            <p><span>作者</span></p>
                            <div class="textWrap " style="position: relative;">
                                <input type="text" id="source_f" name="source_f" maxlength="10" style="padding-right: 70px;" value="<%=friendsStory.getSource_f()%>">
                                <div class="sumtips" style="position: absolute; width: 70px; height: 34px; line-height: 34px; text-align: right; font-size: 12px; color: rgb(153, 153, 153); padding-right: 15px; right: 0px; bottom: 0px;"></div></div>
                    ...
                    <div>
                        <input type="submit" class="scbtn" value="更新">
                    </div>
                </form>
