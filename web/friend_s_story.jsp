...
<%
    if (session.getAttribute("friendsstory")==null)
    {
        request.getRequestDispatcher("/Servletfriends_story").forward(request,response);
    }
    String name="登陆";
    ...
    {
        request.getRequestDispatcher("/Servletnews?url=friend_s_story.jsp").forward(request,response);
    }
%>
<html>
<head>
...
<div class="container">
    ...
    <div id="masonry_ghost" class="hide">
        <c:forEach items="${friendsstory}" var="friendsstory">
        <div class="thumbnail">
            <div class="imgs">
                <a href="branch_of_story.jsp?title=${friendsstory.title_f}"><img src="${friendsstory.imagepath_f}"></a>
                <input type="hidden" value="">
            </div>
            <div class="caption">
                <div class="title">${friendsstory.title_f}</div>
                <div class="content">
                </div>
                <div class="author">
                    by
                    <a target="_blank" href="#">${friendsstory.source_f}</a>
                </div>
            </div>
        </div>
        </c:forEach>
