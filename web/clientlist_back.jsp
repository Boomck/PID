    ...
    <div class="content-wrap">
        ...
        <main class="main-cont content mCustomScrollbar">
            <div class="page-wrap">
                ...
                <button class="btn btn-primary-outline"><a href="addnewclient.jsp">添加新用户<a/></button>
                <form action="">
                    <table class="table table-bordered  mb-15">
                        ...
                        <c:forEach items="${employeelist}" var="emp">
                            <tr class="cen">
                                <td>${emp.username}</td>
                                <td>${emp.validation}</td>
                                <td>${emp.valianswer}</td>
                                <td>${emp.mail}</td>
                                <td>${emp.phone}</td>
                                <td>${emp.qqnumber}</td>
                                <td>${emp.wechatnumber}</td>
                                <td>
                                    <a href="/Servlet_select_user_c_id_client?username=${emp.username}">修改</a>
                                    <a href="/Servlet_delete_user?username=${emp.username}">删除</a>
                                </td>
                            </tr>
                        </c:forEach>
