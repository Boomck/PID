...
@WebServlet("/Servlet_changenews")
public class Servlet_changenews extends HttpServlet {
...
//                        String name = fileItem.getString().trim();
                        ...
                        if (target==1){
                            ...
                            newsDao.change_news(title_n,abstract_n,savename,df.format(day),link_n,source_n);
                        }
                       else {
                           newsDao.change_news_withoutimg(title_n,abstract_n,df.format(day),link_n,source_n);
                        }
